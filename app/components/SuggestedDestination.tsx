...
export default function SuggestedDestinations() {
    ...
    return (
        <section className="py-16 px-6 md:px-20">
            <div className="lg:flex lg:justify-between lg:flex-row py-4" style={{marginBottom: "40px"}}>
                <div>
                    ...
                    <h2 className="text-3xl md:text-4xl text-black font-bold mb-3">
                ...
                <div className="grid grid-cols-2 gap-3 my-4">
                    <button className="px-4 border border-pink-600 text-pink-600 rounded-full text-sm hover:bg-pink-50 transition">
